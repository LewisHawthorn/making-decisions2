...
//You can make sure your code works for exactly 7 elements by using an else if rather than an else (which would assign the seventh value of myFavouriteNumbers to sum even if it contained exactly 7 elements.
//You get the 7th element of an array with an index of 6
...
switch(letterGrade) {
    case 'A':
    console.log("The student is doing excellently."); break;
    case 'B':
    console.log("The student is doing well."); break;
    case 'C':
    console.log.apply("The student is doing alright."); break;
    case 'D':
    console.log("The student is not doing very well."); break;
    case ' F':
    console.log("The student is failing."); break;
